...
struct ITM
{
  ...
  // Stimulus Ports
  using SP = reg<base + 0x0, 0x00000000, 32>;
  // Trace Enable Register
  struct TER : reg<base + 0xE00>
  {
  ...
  struct LSR : reg<base + 0xFB4, 0x00000003>
  {
  ...
  using PID4 = reg<base + 0xFD0, 0x00000004>;
  using PID5 = reg<base + 0xFD4>;
  using PID6 = reg<base + 0xFD8>;
  using PID7 = reg<base + 0xFDC>;
  using PID0 = reg<base + 0xFE0, 0x00000001>;
  using PID1 = reg<base + 0xFE4, 0x000000B0>;
  using PID2 = reg<base + 0xFE8, 0x0000001B>;
  using PID3 = reg<base + 0xFEC>;
  using CID0 = reg<base + 0xFF0, 0x0000000D>;
  using CID1 = reg<base + 0xFF4, 0x000000E0>;
  using CID2 = reg<base + 0xFF8, 0x00000005>;
  using CID3 = reg<base + 0xFFC, 0x000000B1>;
}; // struct ITM
