...
static constexpr auto name = "STM32F103T4";

static constexpr auto cpu_arch = arch::CM3;

static constexpr auto cpu_endian = endian::little;

static constexpr uint32_t rom_size = 16384;

static constexpr uint32_t ram_size = 6144;

static constexpr uint32_t pins = 36;
