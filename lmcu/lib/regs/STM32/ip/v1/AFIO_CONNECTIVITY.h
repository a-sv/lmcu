...
struct AFIO_CONNECTIVITY
{
  ...
  struct MAPR : reg<ip_ver, base + 0x4>
  {
    ...
    // Ethernet MAC I/O remapping (bits: 21)
     ETH_REMAP_MASK = 0x00200000
    ,ETH_REMAP_POS = 21
    ,ETH_REMAP = 0x00200000
    // CAN2 I/O remapping (bits: 22)
    ,CAN2_REMAP_MASK = 0x00400000
    ,CAN2_REMAP_POS = 22
    ,CAN2_REMAP = 0x00400000
    // MII or RMII selection (bits: 23)
    ,MII_RMII_SEL_MASK = 0x00800000
    ,MII_RMII_SEL_POS = 23
    ,MII_RMII_SEL = 0x00800000
    // SPI3/I2S3 remapping (bits: 28)
    ,SPI3_REMAP_MASK = 0x10000000
    ,SPI3_REMAP_POS = 28
    ,SPI3_REMAP = 0x10000000
    // TIM2 internal trigger 1 remapping (bits: 29)
    ,TIM2ITR1_IREMAP_MASK = 0x20000000
    ,TIM2ITR1_IREMAP_POS = 29
    ,TIM2ITR1_IREMAP = 0x20000000
    // Ethernet PTP PPS remapping (bits: 30)
    ,PTP_PPS_REMAP_MASK = 0x40000000
    ,PTP_PPS_REMAP_POS = 30
    ,PTP_PPS_REMAP = 0x40000000
