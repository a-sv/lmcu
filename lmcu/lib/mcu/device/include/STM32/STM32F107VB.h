...
static constexpr auto name = "STM32F107VB";
...
static constexpr uint32_t pins = 100;
...
constexpr irqn find_irqn(const char *name) noexcept
{
  constexpr std::pair<const char*, irqn> irqlst[] =
  {
    ...
    {"eth", irqn::eth},
    {"eth_wkup", irqn::eth_wkup},
    {"can2_rx0", irqn::can2_rx0},
    {"can2_rx1", irqn::can2_rx1},
    {"can2_sce", irqn::can2_sce},
    {"otg_fs", irqn::otg_fs},
    {"nmi", irqn::nmi},
