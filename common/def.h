#pragma once
  ...
  #pragma message("warning: inlining disabled, this may cause problems with lmcu correct working!")
#else
...
#define lmcu_enum_class_flags_impl(T) \
  ...
  \
  constexpr bool operator ==(T lhs, T rhs) = delete; // use only operator & for flags checking
